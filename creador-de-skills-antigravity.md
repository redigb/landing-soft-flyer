...
En cada SKILL.md, incluye una sección de “Cuándo usar este skill” con triggers claros. Ejemplos:
...
3.  A partir de ahí, para crear un skill nuevo, pide:
    “Usa mi documento ‘creador-de-skills-antigravity’ y construye un skill para: <OBJETIVO>. Devuélveme la carpeta, el SKILL.md y los recursos necesarios.”
